...
- StatusDot Mini turns the user's request into a directly usable web workflow. The first experience must be the actual web product behavior, not a marketing landing page or placeholder demo.
- - FR-001: Build a tiny single-page utility called StatusDot Mini. It should manage three status dots, toggle ready/warn/fail states, persist to localStorage, expose window.app state, and export a JSON snapshot. Keep it static HTML/CSS/JS only.
...
- Three Operations - StatusDot Mini
- Three Editor - StatusDot Mini
- Insights - StatusDot Mini

## SCREEN_SPECS
SCREEN_SPEC_1:
- exact_screen_title: Three Operations - StatusDot Mini
...
SCREEN_SPEC_2:
- exact_screen_title: Three Editor - StatusDot Mini
...
SCREEN_SPEC_3:
- exact_screen_title: Insights - StatusDot Mini
